...
const Video = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (videoRes.data) await api.put(`/videos/view/${path}`);
  ...
  const handleShare = async () => {
    ...
    try {
      const res = await api.put(`/users/share/${currentVideo._id}`);
      ...
      <Content>
        ...
        <Details>
          <Info>
            ...
            {timeagoInstance.format(currentVideo?.createdAt)}
          </Info>
          <Buttons>
